...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("Data/combined/pwsid/HB_vio_", i, ".rds"))
...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("Data/combined/pwsid/lcr_vio_", i, ".rds"))
...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("Data/combined/pwsid/pfas_vio_", i, ".rds"))
...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("Data/combined/pwsid/dbp_vio_", i, ".rds"))
...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("Data/combined/pwsid/tcr_vio_", i, ".rds"))
...
# Create loop function to call each boundary and combine with indicator
  ...
  # Load the demographic datasets by boundary
  pwsid_dem <- read.csv(paste0("data/demographics/epic_dems_area.csv")) %>%
    clean_names() %>%
    dplyr::select(-ends_with("state")) %>%
    rename_with(
      ~ case_when(
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("data/combined/ars_vio_epic.rds"))
...
for (i in boundary) {
  ...
  #Save the dataset
  saveRDS(cbg_vio, file = paste0("data/combined/nitrate_vio_epic.rds"))
