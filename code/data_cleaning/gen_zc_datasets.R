################################################################################
##Generate PWSID level datasets : zip code boundaries
##NCEE EPA 
...
pwsid_dem <- read_excel("Data/zc_boundaries/zc_dems.xlsx") %>%
  clean_names()
...
write_rds(HB_vio, "Data/combined/HB_vio_zc.rds") #save data for future use (as rds because will convert variable types otherwise)
...
write_rds(lcr_vio, "Data/combined/lcr_vio_zc.rds") #save data for future use (as rds because will convert variable types otherwise)
...
write_rds(pfas_vio, "Data/combined/pfas_vio_zc.rds") #save data for future use (as rds because will convert variable types otherwise)
...
write_rds(dbp_vio, "Data/combined/dbp_vio_zc.rds") #save data for future use (as rds because will convert variable types otherwise)
...
write_rds(tcr_vio, "Data/combined/tcr_vio_zc.rds") #save data for future use (as rds because will convert variable types otherwise)
