################################################################################
# Demographic Indices for SDWA indicators : USGS boundaries
...
HB_vio <- readRDS("data/combined/HB_vio_usgs.rds")
...
lcr_vio <- readRDS("data/combined/lcr_vio_usgs.rds")
...
pfas_vio <- readRDS("data/combined/pfas_vio_usgs.rds")
...
dbp_vio <- readRDS("data/combined/dbp_vio_usgs.rds")
...
tcr_vio <- readRDS("data/combined/tcr_vio_usgs.rds")
