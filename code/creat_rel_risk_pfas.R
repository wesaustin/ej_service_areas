...
vars = c('total_samples', 'detection_share', 'concentration_max', 'concentration_avg', 'pfas_count')
...
for (b in boundary) {
  ...
  my_df <- data.frame(race_cat = c("amerind", "asian", "black", "hisp", "pacisl", "poc", "lowinc"))
...
write.csv(all_risk, file = "Data/rel_risk/rel_risk_pfas_sensitivity.csv")
